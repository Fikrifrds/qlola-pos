    ...
    >
      ...
      <div className={classes.actions}>
        {numSelected > 0 ? (
          ...
          {/* <SearchBoxV2 placeholder="Cari Produk..." searchField={props.searchField} setSearchField={props.setSearchField} onChange={props.handleChangeSearch} /> */}
...
export default function ProductTable() {
  ...
  const productContext = useContext(ProductContext);
    ...
    useEffect(() => {
      setData(productContext.products);
      setRows(productContext.products);
    }, [])
  ...
  rows.filter( row => row.name.toLowerCase().includes(searchField.toLowerCase()))
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell>
                      <img src={row.imgUrl} width="40px" alt="product"/>
                      </TableCell>
